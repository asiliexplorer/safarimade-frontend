...
const KilimanjaroPackageDetailsPage = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        const pkg = mockPackages.find((p) => {
          if (p.Mount === "Kilimanjaro") {
            return slugifyPackageName(p.name) === slug;
          }
          return false;
        });
        if (pkg) {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/climbing-kilimanjaro-tour-packages" className="text-[#465b2d] hover:underline">
...
>
  ...
  <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <Link 
      href="/climbing-kilimanjaro-tour-packages"
          ...
          <div className="lg:w-3/4">
            ...
            <div className="mt-12 bg-white rounded-3xl p-8 border border-gray-200 text-center shadow-2xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link href="/climbing-kilimanjaro-tour-packages" className="border-2 border-[#465b2d] text-[#465b2d] px-8 py-4 rounded-xl font-semibold hover:bg-[#465b2d] hover:text-white transition-colors duration-200">
                  VIEW ALL PACKAGES
                </Link>
              </div>
            </div>
...
export default KilimanjaroPackageDetailsPage;