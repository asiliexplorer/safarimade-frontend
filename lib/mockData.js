...
const wildebeestMigrationSafaris = [
  {
    id: 1,
    name: "5-Day Great Migration Safari - Northern Serengeti",
    offeredBy: "Serengeti Explorer Safaris",
    tourOperator: "Serengeti Explorer Safaris",
    rating: 4.8,
    reviewCount: 312,
    shortDescription: "Witness dramatic Mara River crossings in Northern Serengeti during peak migration season.",
    fullDescription: "This safari focuses on the Northern Serengeti where wildebeest cross the Mara River. Expect thrilling predator action and breathtaking wildlife scenes.",
    duration: 5,
    price: 3200,
    startingFrom: "Arusha",
    comfortLevel: "mid-range",
    tourType: "private",
    safariType: "Wildebeest",
    specializedTours: ["migration", "wildlife"],
    features: ["best for river crossings", "can start any day", "private guide"],
    image: "https://images.unsplash.com/photo-1549366021-9f761d450615?q=80&w=870",
    highlights: ["Northern Serengeti", "Mara River crossing", "Ngorongoro Crater"],
    destinations: ["Arusha", "Serengeti National Park", "Ngorongoro Crater"],
    route: {
      start: "Arusha (Day 1)",
      end: "Arusha (Day 5)",
      days: [
        { day: 1, location: "Serengeti NP", description: "" },
        { day: "2-3", location: "Northern Serengeti", description: "" },
        { day: 4, location: "Ngorongoro", description: "" },
        { day: 5, location: "End", description: "" }
      ]
    },
    tourFeatures: ["Mid-range tour", "Private safari", "Migration focused"],
    activitiesTransportation: {
      activities: ["game drives"],
      vehicle: "4x4 safari vehicle",
      transfer: "Airport transfers included"
    },
    accommodationMeals: {
      note: "Extra nights available",
      schedule: []
    },
    gallery: [
      "https://images.unsplash.com/photo-1516426122078-c23e76319801",
      "https://images.unsplash.com/photo-1551632811-561732d1c5e0"
    ],
    dayByDay: [],
    rates: { disclaimer: "", pricing: [] },
    inclusions: { included: ["Guide", "Meals", "Park fees"], excluded: ["Flights", "Visa"] },
    gettingThere: { description: "Starts in Arusha", details: [] }
  },
    {
      day: 2,
      ...
      images: ["https://images.unsplash.com/photo-1551632811-561732d1c5e0"],
    ...
    },
    {
      day: 3,
      location: "Central Serengeti",
      description: "Full-day migration tracking and predator viewing.",
      accommodation: "Kati Kati Camp",
      accommodationType: "Tented camp",
      meals: "All meals included",
      drinks: "Soft drinks included",
      images: ["https://images.unsplash.com/photo-1508672019048-805c876b67e2"],
      bestTimeToVisit: "Year-round",
      highSeason: "June to October",
      bestWeather: "Dry season",
      wildlife: [
    ...
    },
    {
      day: 5,
      location: "Northern Serengeti",
      description: "Witness river crossings.",
      accommodation: "Mara Camp",
      accommodationType: "Migration camp",
      meals: "All meals included",
      drinks: "Soft drinks included",
      images: ["https://images.unsplash.com/photo-1474511012034-6a8d5d3e04c7"],
      bestTimeToVisit: "July to September",
      highSeason: "Peak migration",
      bestWeather: "Dry",
      wildlife: [
